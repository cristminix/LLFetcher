import { A as App, C as Course, c as Author, b as DB, T as Toc, S as StreamLocation, a as DownloadState, D as Download, d as Section } from './StreamLocation.8ca84ae5.js';
...
class ComponentWithMessaging extends react.exports.Component {
...
const mCourse$3 = await Course.getInstance();
const mAuthor$1 = await Author.getInstance();
class WelcomePage extends ComponentWithMessaging {
  ...
  async createAuthors(authors, course) {
    for (let i in authors) {
      ...
      const author = await mAuthor$1.create(name, slug, biography, shortBiography, course.id);
      if (this.courseAuthors.filter((_author_) => _author_.id === author.id).length === 0) {
        this.courseAuthors.push(author);
        course = await mCourse$3.addAuthorId(course.id, author.id);
      }
    }
    return course;
  }
  async createCourse(ci) {
    ...
    let course = await mCourse$3.create(title, slug, duration, sourceCodeRepository, description, urn);
    console.log(course);
    ...
    return /* @__PURE__ */ jsx(Fragment, {
      children: /* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsx("p", {
          ...
          className: "action-cnt",
          children: [lastCourseListKeys.length > 0 ? /* @__PURE__ */ jsx(Fragment, {
            children: /* @__PURE__ */ jsxs("div", {
              className: "dropdown",
              children: [/* @__PURE__ */ jsxs("button", {
                ...
                children: [/* @__PURE__ */ jsx("i", {
                  className: loading ? "fa fa-spin fa-spinner" : "fa fa-history"
                }), " Load Recent Course"]
              }), /* @__PURE__ */ jsx("ul", {
                className: "dropdown-menu",
                "aria-labelledby": "recentCourseButton",
                children: lastCourseListKeys.map((slug, index) => {
                  const course = lastCourseList[slug];
                  return /* @__PURE__ */ jsx("li", {
                    children: /* @__PURE__ */ jsx("a", {
                      className: "dropdown-item",
                      href: "#",
                      onClick: (e) => this.onSelectCourse(course),
            ...
            children: /* @__PURE__ */ jsxs("button", {
              ...
              onClick: (e) => this.getCourseInfoMessage(),
              children: [/* @__PURE__ */ jsx("i", {
                className: `fa ${btnCls}`
              }), " Fetch This Course"]
            })
...
await Course.getInstance();
const mToc$1 = await Toc.getInstance();
const mStreamloc$1 = await StreamLocation.getInstance();
const mExfile$1 = await ExerciseFile.getInstance();
class FetchButton extends ComponentWithMessaging {
  ...
  async saveRecords(tocUp, exFile, streamLocations) {
    ...
    const exerciseFile = await mExfile$1.create(name, exFile.url, sizeInBytes, this.course.id);
    const streamlocIds = [];
    const streamlocs = [];
    for (let i in streamLocations) {
      ...
      const streamloc = await mStreamloc$1.create(fmt, url, this.state.toc.id);
    ...
    const toc = await mToc$1.update(this.state.toc.id, tocUp.url, captionUrl, captionFmt, streamlocIds);
    this.setState({
      toc,
      exerciseFile,
      streamlocs
  ...
  async loadCourseToc() {
    const toc = mToc$1.get(this.state.toc.id);
    const exerciseFile = mExfile$1.getByCourseId(this.course.id);
    const streamlocs = mStreamloc$1.getListByTocId(this.state.toc.id);
    this.setState({
      toc,
      exerciseFile,
      streamlocs
  ...
  render() {
    ...
    const btnStyle = {
      border: btnStateNotLoading ? "none" : "inherit"
    };
    const iconCls = btnState === 1 ? "fa-play" : btnState === 2 ? "fa-spin fa-spinner" : btnState === 3 ? "fa-check" : btnState === 4 ? "fa-refresh" : "fa-play";
    return /* @__PURE__ */ jsx(Fragment, {
...
class TocToolBar extends react.exports.Component {
  fetchBtnRef = null;
  constructor(props) {
    super(props);
    this.fetchBtnRef = react.exports.createRef(null);
  }
  render() {
    const {
      toc,
    ...
    return /* @__PURE__ */ jsx(Fragment, {
      children: /* @__PURE__ */ jsx(FetchButton, {
        ref: this.fetchBtnRef,
        toc,
        sidx,
        tidx,
        course
      ...
      children: /* @__PURE__ */ jsx("div", {
        ...
        children: /* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsx("div", {
            ...
            className: "item",
            children: /* @__PURE__ */ jsx(TocToolBar, {
              course,
              ref: tocToolBarRefs[section.slug][tidx],
              toc,
              sidx,
              tidx
            })
...
class FetchQueue extends react.exports.Component {
  prefixCls = null;
  constructor(props) {
    super(props);
    const {
  ...
  render() {
    ...
    return /* @__PURE__ */ jsxs(Fragment, {
      children: [" ", /* @__PURE__ */ jsxs("div", {
        ...
        style: style.qcnt,
        children: [/* @__PURE__ */ jsx("div", {
          className: `${prefixCls}-pb item`,
          style: {
            width: 100
          },
          children: !hideProgress ? /* @__PURE__ */ jsx("div", {
            className: "progress",
            children: /* @__PURE__ */ jsx("div", {
        ...
        }), !hideBtn ? /* @__PURE__ */ jsx("div", {
          className: `btn-${prefixCls}-cnt item`,
          style: {
            position: "absolute"
          },
          children: /* @__PURE__ */ jsx("button", {
            style: Object.assign({
              color: btnState === 3 ? "white" : "inherit"
            }, style.btnFetch),
            disabled: btnState !== 1 && btnState !== 4,
...
class FetchQueueBar extends FetchQueue {
  ...
  async startQueue() {
    ...
    while (tidx = queues.shift()) {
      ...
      if (fetchBtn.isFetched()) {
        nidx += 1;
        const percentage = Math.ceil(Math.floor(nidx / items.length * 100));
        onUpdateQueueProgress("FetchQueueBar", {
          sidx,
          section,
          percentage
        });
      ...
      if (validResource) {
        ...
        const retryCount2 = this.state.retryCount;
        if (retryCount2[tidx] < 2) {
          queues.push(tidx);
          retryCount2[tidx] += 1;
          console.log(retryCount2);
          this.setState({
  ...
  checkProgressItem(queues, items) {
    ...
    let percentage = Math.ceil(Math.floor(nidx / items.length * 100));
    return percentage;
  }
...
class SectionToolBar extends react.exports.Component {
  fetchQueueRef = null;
  constructor(props) {
    super(props);
    this.fetchQueueRef = react.exports.createRef(null);
  }
  async processQueue() {
    const {
      sidx,
  ...
  render() {
    ...
    return /* @__PURE__ */ jsx(Fragment, {
      children: /* @__PURE__ */ jsx("div", {
        ...
        children: /* @__PURE__ */ jsx(FetchQueueBar, {
          sidx,
          section,
          runSectionQueue,
          runTocsQueue,
    ...
    children: /* @__PURE__ */ jsxs("div", {
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsx("div", {
          className: "item",
          children: /* @__PURE__ */ jsx("button", {
            className: "btn btn-default accordion-button custom btn-collapse",
            ...
            children: /* @__PURE__ */ jsx("i", {
              className: !collapsed ? "fa fa-minus" : "fa fa-plus"
            })
          })
        }), /* @__PURE__ */ jsxs("div", {
          className: "item",
          ...
          children: [section.title, " (", items.length, ")"]
        }), /* @__PURE__ */ jsx("div", {
          className: "item",
          children: /* @__PURE__ */ jsx(SectionToolBar, {
            tocToolBarRefs,
            ref: sectionToolBarRefs[sidx],
            items,
            sidx,
            section,
            runSectionQueue,
        ...
        className: "course-section-items-container",
        style: {
          padding: ".5em 0 .5em 1.5em",
          display: !collapsed ? "block" : "none"
        },
        children: items.map((toc, index) => {
          return /* @__PURE__ */ jsx(CourseToc, {
            course,
            toc,
            section,
            sidx,
...
const CourseTree = ({
  ...
  const [warningText, setWarningText] = react.exports.useState("");
  ...
  if (sections.length > 0) {
    return /* @__PURE__ */ jsx(Fragment, {
      children: /* @__PURE__ */ jsx("div", {
        ...
        id: "accordion-course-tree",
        children: sections.map((section, index) => {
          const items = tocs[section.slug];
          return /* @__PURE__ */ jsx(CourseSection, {
            course,
            section,
            items,
            sidx: index,
    ...
    return /* @__PURE__ */ jsx(Fragment, {
      children: /* @__PURE__ */ jsxs("span", {
        children: [/* @__PURE__ */ jsx("i", {
          className: loading ? "fa fa-spin fa-spinner" : "fa fa-exclamation"
        }), " ", warningText, " "]
      })
    });
  }
...
class FetchSectionQueue extends FetchQueue {
  ...
  updateProgressIter(sidx, itemsLength, key, inc = 0) {
    ...
    const percentage = Math.ceil(Math.floor(nidx / itemsLength * 100));
    this.setState({
      qiData: {
        current: sidx,
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: /* @__PURE__ */ jsxs("div", {
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: /* @__PURE__ */ jsx(FetchSectionQueue, {
          course,
          sections,
          tocs,
          runSectionQueue,
...
const mCourse$2 = await Course.getInstance();
class CoursePage extends react.exports.Component {
  mainQueueRef = null;
  sectionToolBarRefs = [];
  tocToolBarRefs = {};
  constructor(props) {
  ...
  initRefs(sections, tocs) {
    this.mainQueueRef = react.exports.createRef(null);
    this.sectionToolBarRefs = [];
    for (let sidx in sections) {
      this.sectionToolBarRefs.push(react.exports.createRef(null));
    }
    for (let key in tocs) {
      this.tocToolBarRefs[key] = [];
      for (let tidx in tocs[key]) {
        this.tocToolBarRefs[key].push(react.exports.createRef(null));
      }
    }
  }
  async componentDidMount() {
    ...
    if (!course) {
      const slug = await mCourse$2.getLastSlug();
      if (slug) {
        if (slug !== "") {
          const {
            course: course2,
            ...
            sections,
            tocs
          } = await mCourse$2.getCoursePageData(slug);
          this.initRefs(sections, tocs);
          this.setState({
            course: course2,
            authors,
  ...
  render() {
    ...
    return /* @__PURE__ */ jsx(Fragment, {
      children: course ? /* @__PURE__ */ jsxs("div", {
        className: "course-page page",
        children: [/* @__PURE__ */ jsx(CourseDetail, {
          course,
          sections,
          tocs,
          qsidx,
          ...
          pageNavigationRef,
          children: /* @__PURE__ */ jsx(CourseAuthors, {
            authors
          }, course.id)
        }), /* @__PURE__ */ jsx(CourseTree, {
          course,
          sections,
          tocs,
          qsidx,
...
const DLAux = ({
  ...
  return /* @__PURE__ */ jsxs("div", {
    children: [fmt ? /* @__PURE__ */ jsxs(Fragment, {
      children: [/* @__PURE__ */ jsxs("div", {
        className: "dl-playlist-cnt",
        children: [/* @__PURE__ */ jsx("label", {
          className: "form-label",
          children: "Playlist : "
        }), /* @__PURE__ */ jsxs("a", {
          onClick: (e) => downloadFile("playlist"),
          href: "#",
          children: [course.slug, "-", fmt, ".m3u"]
        })]
      }), /* @__PURE__ */ jsxs("div", {
        className: "dl-playlist-cnt",
        children: [/* @__PURE__ */ jsx("label", {
          className: "form-label",
          children: "Helper Bash : "
        }), /* @__PURE__ */ jsxs("a", {
          onClick: (e) => downloadFile("shell_script"),
          href: "#",
          children: [course.slug, "-", fmt, "-helper.sh"]
        })]
      }), /* @__PURE__ */ jsxs("div", {
        className: "dl-playlist-cnt",
        children: [/* @__PURE__ */ jsx("label", {
          ...
          onClick: (e) => downloadFile("batch_script"),
          href: "#",
          children: [course.slug, "-", fmt, "-helper.bat"]
        })]
      })]
    }) : "", course.sourceCodeRepository ? /* @__PURE__ */ jsx("div", {
      className: "exercise-file-cnt",
      children: /* @__PURE__ */ jsxs("div", {
        children: [/* @__PURE__ */ jsx("label", {
          className: "form-label",
          ...
          target: "_blank",
          href: course.sourceCodeRepository,
          children: course.sourceCodeRepository
        })]
      })
    }) : ""]
  });
...
class LogBar extends react.exports.Component {
  constructor(props) {
    super(props);
    this.props.data;
  }
  render() {
    ...
    return /* @__PURE__ */ jsx(Fragment, {
      children: /* @__PURE__ */ jsx("div", {
        className: "log-bar",
        children: mode >= 0 && message ? /* @__PURE__ */ jsx("div", {
          className: `log-message ${mode === 1 ? "error" : mode === 0 ? "success" : "warning"}`,
          children: /* @__PURE__ */ jsxs("span", {
            children: [message, " ", pct, "%"]
          })
        }) : ""
      })
    });
...
const DLConfig = ({
  ...
  const [fmtValue, setFmt] = react.exports.useState(fmt);
  const [pct, setPct] = react.exports.useState(0);
      ...
      chrome.downloads.search({
        ...
        if (item.length > 0) {
          ...
          if (item.totalBytes > 0) {
            const percentage2 = Math.ceil(Math.floor(item.bytesReceived / item.totalBytes * 100));
            resolve(percentage2);
          } else {
            resolve(-1);
          }
  ...
  return /* @__PURE__ */ jsxs("div", {
    className: "dl-config-cnt",
    children: [/* @__PURE__ */ jsxs("div", {
      className: "text-center",
      children: [/* @__PURE__ */ jsx("label", {
        className: "form-label",
        children: "Set video quality : "
      }), /* @__PURE__ */ jsxs("select", {
        className: "form-control",
        onChange: (e) => updateSelectedFmt(e),
        style: {
          width: "120px",
          display: "inline"
        },
        ...
        children: ["Available video format: ", fmtList.join(", ")]
      })]
    }), fmtList ? /* @__PURE__ */ jsxs(Fragment, {
      children: [/* @__PURE__ */ jsxs("div", {
        className: "dl-batch-cnt text-center",
        children: [/* @__PURE__ */ jsxs("div", {
          className: "btn-group",
          children: [/* @__PURE__ */ jsxs("button", {
            ...
            children: [/* @__PURE__ */ jsx("i", {
              className: `fa ${iconCls}`
            }), " Download All Video & Caption", percentage ? ` ${percentage}%` : ""]
        ...
        children: /* @__PURE__ */ jsxs("table", {
          ...
          children: [/* @__PURE__ */ jsx("thead", {
            ...
            children: downloads.map((dl, index) => {
...
const DLExerciseFile = ({
  ...
  return /* @__PURE__ */ jsx("div", {
    className: "exercise-file-cnt text-center",
    children: exerciseFile.url ? /* @__PURE__ */ jsxs("div", {
      children: [/* @__PURE__ */ jsx("label", {
        className: "form-label",
        children: "Exercise File: "
      }), /* @__PURE__ */ jsx("a", {
        onClick: (e) => downloadExerciseFile(),
        href: "#",
        children: exerciseFile.name
      })]
    }) : ""
  });
};

const mCourse$1 = await Course.getInstance();
...
class DownloadPage extends ComponentWithMessaging {
  ...
  constructor(props) {
    super(props);
    this.logBarRef = react.exports.createRef(null);
    this.state = {
  ...
  async updateDownloadState(data) {
    ...
    if (typeof percentage != "undefined") {
      ...
      await mDlState.set(course.id, state);
    }
    this.setState({
      downloadState: state,
      logBarData: {
  ...
  async populateDownloads(course, sections, tocs, fmt) {
    const downloads = [];
    `http://localhost/linked-learning/${course.slug}`;
    for (let sidx in sections) {
      const section = sections[sidx];
      const items = tocs[section.slug];
      for (let tidx in items) {
  ...
  async loadDownloadData() {
    const lastCourseSlug = await mCourse$1.getLastSlug();
    const {
      course,
      authors,
      sections,
      tocs
    } = await mCourse$1.getCoursePageData(lastCourseSlug);
  ...
  render() {
    ...
    console.log(course);
    return /* @__PURE__ */ jsx("div", {
      className: "download-page page",
      children: course ? /* @__PURE__ */ jsxs("div", {
        className: "dl-cnt",
        children: [exerciseFile ? /* @__PURE__ */ jsx(DLExerciseFile, {
          exerciseFile
        }) : "", downloadConfig ? /* @__PURE__ */ jsx(DLConfig, {
          activeDownloadId,
          ...
          fmtList,
          fmt,
          onSelectFmt: (fmt2) => this.onSelectFmt(fmt2)
        }) : "", downloadConfig ? /* @__PURE__ */ jsx(DLAux, {
          course,
          fmt,
          downloadFile: (t) => this.downloadFile(t)
        }) : ""]
      }) : ""
    });
  }
...
const mApp$1 = await App.getInstance();
class PageNavigation extends react.exports.Component {
  ...
  componentDidMount() {
    this.setState({
      lastCourseSlug: mApp$1.get().lastCourseSlug
    });
  }
  ...
  render() {
    ...
    return /* @__PURE__ */ jsx("div", {
      className: "page-navigation text-center",
      children: /* @__PURE__ */ jsxs("div", {
        className: "btn-group",
        children: [/* @__PURE__ */ jsxs("button", {
          disabled: activeNav === "welcome",
          onClick: (evt2) => this.onNavClick("welcome"),
          className: this.getBtnCls("welcome"),
          children: [/* @__PURE__ */ jsx("i", {
            className: "fa fa-home"
          }), " Welcome"]
        }), /* @__PURE__ */ jsxs("button", {
          disabled: lastCourseSlug === "" || activeNav === "course",
          onClick: (evt2) => this.onNavClick("course"),
          className: this.getBtnCls("course"),
          title: lastCourseSlug,
          children: [/* @__PURE__ */ jsx("i", {
            className: "fa fa-bookmark"
          }), " Course ", lastCourseSlug !== "" ? `(1)` : ""]
        }), /* @__PURE__ */ jsxs("button", {
          disabled: activeNav === "download" || !enableDownloadPage,
          onClick: (evt2) => this.onNavClick("download"),
          className: this.getBtnCls("download"),
          children: [/* @__PURE__ */ jsx("i", {
            className: "fa fa-download"
          }), " Downloads"]
        }), enableOptionPage ? /* @__PURE__ */ jsxs("button", {
          disabled: activeNav === "option",
          onClick: evt = this.onNavClick("option"),
          className: this.getBtnCls("option"),
          children: [/* @__PURE__ */ jsx("i", {
            className: "fa fa-cog"
          }), " Option"]
        }) : "", /* @__PURE__ */ jsxs("button", {
          disabled: activeNav === "setting",
          onClick: (evt2) => this.onNavClick("setting"),
          className: this.getBtnCls("setting"),
          children: [/* @__PURE__ */ jsx("i", {
            className: "fa fa-cog"
          }), " Setting"]
        })]
...
const SettingPage = ({}) => {
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: /* @__PURE__ */ jsx("div", {
      ...
      children: /* @__PURE__ */ jsxs("button", {
        onClick: (e) => onClearStorage(),
        className: "btn btn-sm btn-danger",
        children: [/* @__PURE__ */ jsx("i", {
          className: loading ? "fa fa-spin fa-spinner" : "fa fa-database"
        }), " Clear Storage"]
      })
    })
  });
    ...
    this.setState({
      ...
      if (this.state.course.slug !== "") {
        ...
        this.setState({
          ...
          konsole.log(course, sections2, tocs2);
        });
...
class Popup extends PopupAction {
  ...
  constructor(props) {
    super(props);
    this.pageNavigationRef = react.exports.createRef(null);
  }
  setPage() {
    const pages = {
      welcome: /* @__PURE__ */ jsx(WelcomePage, {
        onSelectCourse: (a, b, c) => this.onSelectCourse(a, b, c)
      }),
      course: /* @__PURE__ */ jsx(CoursePage, {
        setNav: (nav) => this.setState({
          nav
        }),
        course: this.state.course,
      ...
      download: /* @__PURE__ */ jsx(DownloadPage, {}),
      help: /* @__PURE__ */ jsx(DownloadPage, {}),
      setting: /* @__PURE__ */ jsx(SettingPage, {}),
      option: /* @__PURE__ */ jsx(OptionPage, {})
    };
  ...
  render() {
    return /* @__PURE__ */ jsxs("div", {
      ...
      children: [this.setPage(), /* @__PURE__ */ jsx(PageNavigation, {
        ref: this.pageNavigationRef,
        onNavUpdate: (nav) => this.onNavUpdate(nav),
        nav: this.state.nav
      })]
    });
  }
...
client.createRoot(document.getElementById("popup")).render(/* @__PURE__ */ jsx(React.StrictMode, {
