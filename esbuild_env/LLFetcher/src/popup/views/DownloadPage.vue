...
<script lang="ts">
import { Section_tableField,Course_tableField, DownloadConfig_tableField, ExerciseFile_tableField } from 'LLFetcher/src/types/tableFields';
import { defineComponent, PropType, ref } from 'vue';
import Store from 'LLFetcher/src/libs/store';
import { createDownloadFile } from 'LLFetcher/src/libs/ext';
import { sendMessageBg } from 'LLFetcher/src/libs/utils';
import { Section,Toc } from 'LLFetcher/src/types/lynda';
