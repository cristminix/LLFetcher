...
<script lang="ts">
import { sendMessageSaveDataCodesToLS } from 'LLFetcher/src/libs/utils';
import { defineComponent,ref } from 'vue';
import Store from 'LLFetcher/src/libs/store';
import { Course_tableField } from 'LLFetcher/src/types/tableFields';
import { Course } from 'LLFetcher/src/types/lynda';
