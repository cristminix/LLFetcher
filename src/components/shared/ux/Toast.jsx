    ...
    if (t == "normal") {
      return (
        <>
          {/* <!-- Toast --> */}
          <div
            className={`my-1 max-w-xs bg-white border border-gray-200 rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700 ${displayCls}`}
            role="alert"
          >
            <div className="flex p-4">
              ...
              <div className="ms-3">
                <p className="text-sm text-gray-700 dark:text-gray-400">{toast.message}</p>
              </div>
            </div>
          </div>
          {/* <!-- End Toast --> */}
    ...
    if (t == "closable") {
      return (
        <>
          <div
            id="dismiss-toast"
            className={`my-1 hs-removing:translate-x-5 hs-removing:opacity-0 transition duration-300 max-w-xs bg-white border border-gray-200 rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700 ${displayCls}`}
            role="alert"
          >
            <div className="flex p-4">
              <p className="text-sm text-gray-700 dark:text-gray-400">{toast.message}</p>
...
class Toast extends Component {
  ...
  render() {
    ...
    return (
      <>
        <div className="fixed top-0 right-4 m-4 " style={{ zIndex: 80 }}>
          {toasts}
        </div>
      </>
    )
