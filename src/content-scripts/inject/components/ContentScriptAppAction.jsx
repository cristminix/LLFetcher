...
import { applyJQueryContainsRegex } from "../../../global/fn"
import jQuery from "jquery"
import { getCourseInfo, getCourseSections } from "../fn/legacy"
applyJQueryContainsRegex(jQuery)

class ContentScriptAppAction extends Component {
  constructor(props) {
    super(props)
    this.state = {
...
export default ContentScriptAppAction
