const Button = ({onMouseOver=f=>f,onMouseOut=f=>f,disabled=false,loading=false, icon, className, caption, onClick}) => {
    ...
    return <button onMouseOver={e=>onMouseOver(e)} onMouseOut={e=>onMouseOut(e)} disabled={loading || disabled} onClick={e=>onClick(e)} type="button" className={`${className} ${btnCls}`}>
        {
