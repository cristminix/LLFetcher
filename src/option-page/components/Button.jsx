const Button = ({disabled=false,loading=false, icon, style, caption, onClick}) => {
    ...
    return <button disabled={loading || disabled} onClick={e=>onClick(e)} type="button" className={btnCls}>
        {
