...
import "../../components/styles/DownloadPage.css"

import { sendMessage, makeDelay,createDownloadFile,getDownloadFilenames, queryDownloadProgress,validateUrl,timeout} from "../../components/fn"
...
class MainDownloadPage extends Component{
...
const DownloadPage = ({store}) => {
    return (<><div className="download-page">
        <MainDownloadPage store={store}/>
    </div></>)
}
