...
const CourseSection = ({store,course, section, items, sidx, runSectionQueue, runTocsQueue,
  ...
  return(<><div className="accordion-item">
      <div className="course-section-container flex">
          ...
          <div className="item text-md font-bold" style={{flexGrow:3}}>{section.title} ({items.length})</div>
          <div className="item">
       ...
       <div className="course-section-items-container flex" style={{padding:".5em 0 .5em 1.5em",display:(!collapsed?'block':'none')}}>
        {
