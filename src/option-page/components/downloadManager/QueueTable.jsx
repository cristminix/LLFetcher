...
const QueueTable = ({clearStatusBar, logStatusBar,startQueueItem,store, course, sections, tocs, queueItemRef}) => {
    ...
    return (<><div className="queue-table border rounded-xl shadow-sm p-6 dark:bg-gray-800 dark:border-gray-700">
        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody>
            <QueueItem clearStatusBar={clearStatusBar} logStatusBar={logStatusBar} startQueueItem={startQueueItem} store={store} ref={queueItemRef} course={course} sections={sections} tocs={tocs} />
            </tbody>
        </table>
        </div>
    </div></>)
