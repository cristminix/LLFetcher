      ...
      <div className="course-display flex gap-2 mb-2 bg-gray-50 dark:bg-slate-800 p-4">
        ...
        <div className="">
          <div className="pl-2">
            ...
            <div className="p-2">{/* <i className="fa fa-external-link"/></a> */}</div>
          </div>
        </div>
      </div>
    </>
        ...
        <div className="h-screen">
          <div className="max-w-lg mx-auto p-8">
            <details className="open:bg-white dark:open:bg-slate-900 open:ring-1 open:ring-black/5 dark:open:ring-white/10 open:shadow-lg p-6 rounded-lg" open>
              <summary className="text-sm leading-6 text-slate-900 dark:text-white font-semibold select-none">No course to display ?</summary>
              <div className="mt-3 text-sm leading-6 text-slate-600 dark:text-slate-400">
                <p>
                  Start by{" "}
                  <a className="text-blue-600 hover:text-blue-500 opacity-90 font-bold" href="https://www.linkedin.com/learning" target="_blank">
                    <i className="fa fa-external-link" /> Browse LinkedIn Learning
                  </a>{" "}
