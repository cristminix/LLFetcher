        ...
        {!finished ? (
            ...
            {interupted ? (
              <>
                <Button
                  ...
                  onMouseOver={(e) => logStatusBar("QueueItemToolbar.startQueue", `Resume ${toc.title}`)}
              ...
              <>
                <Button
                  onMouseOut={(e) => clearStatusBar()}
                  onMouseOver={(e) => logStatusBar("QueueItemToolbar.startQueue", `Download ${toc.title}`)}
                  onClick={(e) => startQueueItem(vIndex)}
                  caption={""}
                  disabled={disabled}
                  loading={loading}
          ...
          <>
            <Button
              ...
              onMouseOut={(e) => clearStatusBar()}
              onMouseOver={(e) => logStatusBar("QueueItemToolbar.resetQueueItem", `Reset ${toc.title}`)}
