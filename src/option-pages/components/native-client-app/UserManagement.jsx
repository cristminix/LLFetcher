...
const UserManagement = ({store,config,pageNumber}) => {
    ...
    const gridOptions = {
		...
		actionWidthCls : '1/8',
		widthCls : ['1/5'],
		headers : [/*'ID',*/'Display Name','Username','Email','First Name','Last Name','Passwd','Avatar Url'/*,'Group ID','Created By','Create Date','Last Updated'*/],
		fields : [/*'id',*/'displayName','username','email', 'firstName','lastName','passwd','avatarUrl'/*,'groupId','createdBy','createDate','lastUpdated'*/],
		enableEdit : true,
    ...
    const updateList = async () => {
        ...
        */
        ...
        sendMessage(`nm.api.cms.users`, {limit,page, order_by,order_dir},'background',response=>{
            // console.log({response})
            if(response.output){
	...
	return(<div className="min-h-screen">
        ...
        <div className="explorer-toolbar">
            <div className="flex gap-2">
                ...
                {
                    !showForm?<Button onClick={e=>addMenuForm()} icon="fa fa-plus" caption="Add User"/>:null
                }
