   ...
   const sidebarTgCls = !hideSidebar ? `${cls1} lg:hidden` : `${cls1}`
    return (<>
     ...
     <div className={`sidebar-toggle ${sidebarTgCls}`}> 
       <div className={cls2}> 
         {/*<!-- Navigation Toggle -->*/} 
         <button onClick={e=>{toggleSidebar(e)}} type="button" data-hs-overlay="#application-sidebar" aria-controls="application-sidebar" aria-label="Toggle navigation" className={cls3}> 
