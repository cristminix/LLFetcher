...
import { QueueState, QueueData, QueueResult } from "@/global/class/models/Queue"
...
const QueueMan = forwardRef(
  (
    ...
    const updateQState = async (qItem, qState, state) => {
      ...
      let logMessage = `${qItem.idx} : ${toc.title} ... ${QueueState.toStr(
        qState.state
      )}`
                    ...
                    <>
                      {!queueAllFinished ? (
                        <Button
                          ...
                          caption={`${
                            queueRunning ? "Queue is running" : "Start Queue"
                          }`}
