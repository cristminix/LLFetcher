      ...
      return tocs[s.slug].map((toc, tIndex) => {
        ...
        return (
          <tr key={`${refKey}`} className={trCls}>
            ...
            <td className={tdCls}>
              {" "}
              <div className="cursor-pointer" onMouseOut={(e) => clearStatusBar()} onMouseOver={(e) => logStatusBar("QueueItem.toc.title", toc.title)}>
                {enableFilenameIndex ? `${formatLeadingZeros(number)}-${toc.title}` : toc.title}
              </div>
            </td>
            <td className={tdClsCaptionStatus}>
              {" "}
              <div className="flex">
                <i className="mt-1 fa fa-file-text-o" /> <InputDisplay value={captionSz} ref={captionStatusRefs[refKey]} />{" "}
            ...
            <td className={tdClsVideoStatus}>
              {" "}
              <div className="flex">
                <i className="mt-1 fa fa-file-video-o" /> <InputDisplay value={videoSz} ref={videoStatusRefs[refKey]} />{" "}
